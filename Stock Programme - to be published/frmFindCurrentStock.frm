VERSION 5.00
Begin VB.Form frmFindCurrentStock 
   BackColor       =   &H80000009&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image2 
         Height          =   525
         Left            =   720
         Picture         =   "frmFindCurrentStock.frx":0000
         Top             =   840
         Width           =   495
      End
   ...
   Begin VB.CommandButton cmdFind 
      ...
      Height          =   375
      Left            =   1080
      MouseIcon       =   "frmFindCurrentStock.frx":0DEE
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   375
      Left            =   2280
      MouseIcon       =   "frmFindCurrentStock.frx":0F40
      MousePointer    =   99  'Custom
      TabIndex        =   4
      Top             =   1680
      Width           =   975
   ...
   End
End
Attribute VB_Name = "frmFindCurrentStock"
...
frmCurrentStock.Find_for_Details
'Unload Me
End Sub
...
Me.Top = frmCurrentStock.Top + (frmCurrentStock.Height - Me.Height) / 2
Me.Left = frmCurrentStock.Left + (frmCurrentStock.Width - Me.Width) / 2
