...
Begin VB.Form frmFindBookIssue 
   BackColor       =   &H00FFFFFF&
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.Image Image1 
               Height          =   525
               Left            =   720
               Picture         =   "frmFindBookIssue.frx":0000
               Top             =   2400
               Width           =   495
            End
   ...
   Begin VB.CommandButton cmdFind 
      ...
      Height          =   375
      Left            =   1560
      MouseIcon       =   "frmFindBookIssue.frx":0DEE
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   375
      Left            =   2760
      MouseIcon       =   "frmFindBookIssue.frx":0F40
      MousePointer    =   99  'Custom
      TabIndex        =   8
      Top             =   4080
      Width           =   975
   ...
   End
End
Attribute VB_Name = "frmFindBookIssue"
...
Me.Top = frmBookIssue.Top + (frmBookIssue.Height - Me.Height) / 2
Me.Left = frmBookIssue.Left + (frmBookIssue.Width - Me.Width) / 2
End Sub
