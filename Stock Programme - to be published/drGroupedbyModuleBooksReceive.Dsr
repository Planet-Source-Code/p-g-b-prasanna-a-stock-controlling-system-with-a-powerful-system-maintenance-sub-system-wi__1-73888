VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drGroupedbyModuleBooksReceive 
   Bindings        =   "drGroupedbyModuleBooksReceive.dsx":0000
   Caption         =   "Report - Books Received (By Module)"
   ClientHeight    =   8070
   ClientLeft      =   60
   ClientTop       =   420
   ClientWidth     =   10050
   Icon            =   "drGroupedbyModuleBooksReceive.dsx":001F
   ...
   TopMargin       =   1300
   BottomMargin    =   1440
   DataMember      =   "cmdGroupedbyModuleBooksReceipt_Grouping"
   NumSections     =   7
   SectionCode0    =   1
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   3300
         Object.Height          =   570
         Picture         =   "drGroupedbyModuleBooksReceive.dsx":1C99
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
            ...
            SubFormatType   =   3
         EndProperty
         DataMember      =   "cmdGroupedbyModuleBooksReceipt"
      EndProperty
      ItemType1       =   4
   ...
   EndProperty
End
Attribute VB_Name = "drGroupedbyModuleBooksReceive"
