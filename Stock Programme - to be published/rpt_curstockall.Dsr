VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drAlloncurstock 
   Caption         =   "Report - Current Stock"
   ClientHeight    =   11010
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   15240
   Icon            =   "rpt_curstockall.dsx":0000
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   3300
         Object.Height          =   570
         Picture         =   "rpt_curstockall.dsx":1C7A
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "drAlloncurstock"
